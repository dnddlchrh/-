...
<input class="box1" value="우선생산제품" type="button" onclick="location.href='./first.jsp'">
<input class="box1" value="이익순위" type="button" onclick="location.href='./rank.jsp'">
<input class="box1" value="그룹별재고수량" type="button" onclick="location.href='./1.jsp'">
</div>
</body>
</html>